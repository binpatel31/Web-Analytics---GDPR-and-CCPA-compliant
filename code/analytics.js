...
let data = new Object();
var info = fetch('https://ipinfo.io/json')
...
info.then(function(result) {
		...
		data["fontfamily"] = window.getComputedStyle(document.body,null).getPropertyValue("font-family");
		data["fontsize"] = window.getComputedStyle(document.body,null).getPropertyValue("font-size");
		...
		xhr.open("POST", 'http://127.0.0.1:5000/add', true);
